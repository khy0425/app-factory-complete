#!/bin/bash
# catchy AdMob 자동 적용 스크립트

echo "📱 catchy AdMob 설정 적용 중..."

# 1. AdMob Service 파일 복사
cp admob_setup/admob_service.dart ../flutter_apps/catchy/lib/services/

# 2. pubspec.yaml에 AdMob 의존성 추가
echo "  google_mobile_ads: ^5.1.0" >> ../flutter_apps/catchy/pubspec.yaml
